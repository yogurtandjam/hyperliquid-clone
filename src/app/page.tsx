...
import { MarketDataProvider } from "@/contexts/AppContext";
...
export default function TradingPage() {
  const [layouts, setLayouts] = useState<{ [key: string]: Layout[] }>({
    ...
    sm: [
      ...
      { i: "chart", x: 0, y: 2, w: 6, h: CHART_HEIGHT, minW: 4, minH: 6 },
      {
        i: "trading",
        x: 0,
        y: 10,
      ...
      { i: "equity", x: 0, y: 18, w: 6, h: EQUITY_HEIGHT, minW: 2, minH: 2 },
      { i: "userfeed", x: 0, y: 21, w: 6, h: EQUITY_HEIGHT, minW: 4, minH: 3 },
    ],
    xs: [
      { i: "marketInfo", x: 0, y: 0, w: 4, h: HEADER_HEIGHT, minW: 2, minH: 1 },
      { i: "chart", x: 0, y: 2, w: 4, h: CHART_HEIGHT, minW: 2, minH: 4 },
      { i: "trading", x: 0, y: 8, w: 4, h: ORDERBOOK_HEIGHT, minW: 2, minH: 3 },
      {
        i: "orderbook",
        x: 0,
        y: 12,
      ...
      { i: "equity", x: 0, y: 16, w: 4, h: EQUITY_HEIGHT, minW: 2, minH: 2 },
      { i: "userfeed", x: 0, y: 19, w: 4, h: EQUITY_HEIGHT, minW: 2, minH: 3 },
    ],
  });
